export const Header = (): JSX.Element => {
  return (
    <header data-testid="header" className="flex gap-4 items-center bg-black absolute top-0 w-full">
      <div className="container mx-auto sm:grid sm:grid-cols-1 grid-cols-2 items-center w-full justify-between">
        <div className="flex items-center gap-x-2 w-full pl-6 md:pl-0 py-2">
          <img
            alt="profile"
          ...
          <span className="text-lg text-gray-400 py-4">&</span>
